...
\usepackage{graphicx}
\graphicspath{{./Figuras/}{./Imagens/}} % where to search for the images

\newcommand{\blue}[1]{\textcolor{blue}{#1}}
\newcommand{\red}[1]{\textcolor{red}{#1}}


\autor{Nome Sobrenome} %TCC
\data{2016}
\orientador{Professorius Sapientus} %TCC
...
\titulo{Este é o título do meu Trabalho de Conclusão de Curso} %TCC
